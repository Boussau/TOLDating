...
python ../../Scripts/select_leaves_Archaea.py arc122_r86.1.treeRN -d arc_metadata_r86.tsv -l 1 > outputSelectionLevel1
# Selection at level 2:
python ../../Scripts/select_leaves_Archaea.py arc122_r86.1.treeRN -d arc_metadata_r86.tsv -l 2 > outputSelectionLevel2
# Selection at level 3:
python ../../Scripts/select_leaves_Archaea.py arc122_r86.1.treeRN -d arc_metadata_r86.tsv -l 3 > outputSelectionLevel3
# Selection at level 3:
python ../../Scripts/select_leaves_Archaea.py arc122_r86.1.treeRN -d arc_metadata_r86.tsv -l 4 > outputSelectionLevel4
...
python ~/Documents/Utils/scripts/pruneTreeWithListOfLeaves.py arc122_r86.1.treeRN representant_4 sampled_level4.dnd
